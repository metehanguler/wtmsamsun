<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="konusmaciguncelle.aspx.cs" Inherits="admin_konusmaciguncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="fileinput fileinput-new form-group" data-provides="fileinput">
        ...
        <span class="btn btn-default btn-file"><span></span>
